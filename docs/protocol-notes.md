...
Collateral Vault
 ...
 Locks user collateral and releases it upon valid withdrawal proofs.
...
They do not make lending or liquidation decisions.
...
Valid commitment exists in the deposit tree
...
Repays full loan amount + interest
